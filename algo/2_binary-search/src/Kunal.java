public class Kunal {
    public static void main(String[] args) {
        ...
        System.out.println("rotate: " + countRotation(arr));
    }

    // find rotation count in rotated sorted(increasing) array with distinct numbers
    static int countRotation(int[] arr) {
        ...
        while (left <= right) {
            ...
            // if mid = 2nd ascend's first :- condition: arr[mid] < arr[mid - 1]
            if (arr[mid] < arr[right] && arr[mid] < arr[mid - 1]) {
                // return mid - 1; // for pivot index
                // for rotation, count wil be pivot index + 1;
                return mid;
            }
            // if mid = 1st ascend's last :- condition: arr[mid] < arr[mid + 1]
            if (arr[mid] > arr[right] && arr[mid] < arr[mid + 1]) {
                // return mid; // for pivot index
                // for rotation, count wil be pivot index + 1;
                return mid + 1;
            }
        ...
        // return mid + 1;
        // } else {
        // // we are either in first ascend
        // // or we are in second ascend
        // // -----------------------------
        // if (arr[mid] > arr[right]) {
        // // we are in first ascend
        // left = mid;
        // } else {
        // // we are in second ascend
        // right = mid;
        // }
        // }
        // }
